Contributing to Revolt Core
============================

The Revolt Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Revolt Core
...
Before you start contributing, familiarize yourself with the Revolt Core build
system and tests. Refer to the documentation in the repository on how to build
Revolt Core and how to run the unit tests, functional tests, and fuzz tests.
...
Most communication about Revolt Core development happens on IRC, in the
`#revolt-core-dev` channel on Libera Chat. The easiest way to participate on IRC is
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to revolt-qt
