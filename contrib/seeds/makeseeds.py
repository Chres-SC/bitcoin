...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of revolt node seed ip addresses.')
...
def main():
    ...
    # Filter out hosts with multiple revolt ports, these are likely abusive
    ips = filtermultiport(ips)
    print(f'{ip_stats(ips):s} Filter out hosts with multiple revolt ports', file=sys.stderr)
