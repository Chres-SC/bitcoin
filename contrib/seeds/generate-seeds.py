...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef REVOLT_CHAINPARAMSSEEDS_H\n')
    g.write('#define REVOLT_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the revolt network\n')
    ...
    g.write('#endif // REVOLT_CHAINPARAMSSEEDS_H\n')
