...
debug log about your I2P configuration and connections. Run `revolt-cli help
...
`revolt-cli -addrinfo` to see the number of I2P addresses known to your node.
...
To see which I2P peers your node is connected to, use `revolt-cli -netinfo 4`
or the `getpeerinfo` RPC (e.g. `revolt-cli getpeerinfo`).
