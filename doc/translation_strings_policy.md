...
This document provides guidelines for internationalization of the Revolt Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `revolt_en.ts` remains unchanged.
