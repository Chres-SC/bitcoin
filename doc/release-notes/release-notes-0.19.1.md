...
Revolt core version 0.19.1 is now available from:
...
From Revolt core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Revolt core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Revolt core does not yet change appearance when
...
- #17488 fix "revoltd already running" warnings on macOS (fanquake)
