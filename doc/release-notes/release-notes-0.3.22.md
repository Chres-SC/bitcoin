...
Notable changes:
* Client will accept and relay TX's with 0.0005 RVT fee schedule (users still pay 0.01 RVT per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #revolt00 - #revolt99
