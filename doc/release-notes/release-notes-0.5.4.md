Revolt version 0.5.4 is now available for download at:
...
http://gitorious.org/bitcoin/revoltd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Revolt-Qt notifications under Growl 1.3.
Increase required age of Revolt-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxRevolt properly when installing Revolt-Qt over it. (Windows)
