...
* Ensure a changed revolt unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for revolt-qt.exe
* (Windows only): add meta-data to revolt-qt.exe (e.g. description)
...
* Bash programmable completion for revoltd(1)
