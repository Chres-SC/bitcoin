Revolt Core version 0.17.0 is now available from:
...
- New `fees` field introduced in `getrawmempool`, `getmempoolancestors`, `getmempooldescendants` and
   ...
   and `descendant` denominated in RVT. This new field deprecates previous fee fields, such as
...
- #12240 `6f8b345` Introduced a new `fees` structure that aggregates all sub-field fee types denominated in RVT (mryandao)
