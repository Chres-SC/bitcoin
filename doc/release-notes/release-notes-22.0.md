...
- bitcoin/bitcoin#21029 revolt-cli: Correct docs (no "generatenewaddress" exists) (luke-jr)
...
### RPC and other APIs
- bitcoin/bitcoin#18335, bitcoin/bitcoin#21484 cli: Print useful error if revoltd rpc work queue exceeded (LarryRuane)
...
- bitcoin/bitcoin#20939 fix `RELOC_SECTION` security check for revolt-util (fanquake)
...
- bitcoin/bitcoin#22230 Fix MSVC linker /SubSystem option for revolt-qt.exe (hebasto)
...
- bitcoin/bitcoin#21822 Resolve bug in `interface_revolt_cli.py` (klementtan)
...
- bitcoin/bitcoin#22270 Add revolt-util tests (+refactors) (MarcoFalke)
...
- bitcoin/bitcoin#20715 util: Add argsmanager::getcommand() and use it in revolt-wallet (MarcoFalke)
...
- bitcoin/bitcoin#20884 script: Improve robustness of revoltd.service on startup (hebasto)
...
- bitcoin/bitcoin#21007 revoltd: Add -daemonwait option to wait for initialization (laanwj)
...
- bitcoin/bitcoin#21695 contrib: Remove no longer used contrib/revolt-qt.pro (hebasto)
...
- bitcoin/bitcoin#20913 Add manual page generation for revolt-util (laanwj)
