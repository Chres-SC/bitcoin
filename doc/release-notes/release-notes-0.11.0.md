Revolt Core version 0.11.0 is now available from:
...
defaults to 0.00001. This will cause transactions with fewer RVT/kB fee to be
...
Block pruning allows Revolt Core to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that Revolt Core will 
...
- #6116 `30dc3c1` [OSX] rename Revolt-Qt.app to Revolt-Core.app
