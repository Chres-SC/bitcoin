Revolt Core version 0.13.2 is now available from:
...
- #8908 `4a974b2` Update revolt-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow revolt-tx to create v2 transactions (btcdrak)
