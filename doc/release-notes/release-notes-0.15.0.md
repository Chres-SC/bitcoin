...
* When running Bitcoin Core with a single wallet, there are **no** changes to the RPC interface or `revolt-cli`. All RPC calls and `revolt-cli` commands continue to work as before.
