Revolt version 0.5.0 is now available for download at:
...
For Ubuntu users, there is a new ppa maintained by Matt Corallo which you can add to your system so that it will automatically keep revolt up-to-date.  Just type "sudo apt-add-repository ppa:revolt/revolt" in your terminal, then install the revolt-qt package.
...
If you have a previously encrypted wallet.dat, the first time you run revolt-qt or revoltd the wallet will be rewritten, Revolt will
...
Revolt-Qt: Address Book, then New Address...
...
Drag and drop support for revolt: URIs on web pages.
...
signmessage/verifymessage : new RPC commands to sign a message with one of your private keys or verify that a message signed by the private key associated with a revolt address.
