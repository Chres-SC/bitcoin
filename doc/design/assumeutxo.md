...
Assumeutxo is a feature that allows fast bootstrapping of a validating revoltd
...
considered active. This is the "traditional" mode of operation for revoltd.
...
**Failure consideration:** if revoltd unexpectedly halts after `m_stop_use` is set on
...
### Revoltd restarts sometime after snapshot validation has completed

When revoltd initializes again, what began as the snapshot chainstate is now
