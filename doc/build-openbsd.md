...
This guide describes how to build revoltd, command-line utilities, and GUI on OpenBSD.
...
Revolt Core includes a GUI built with the cross-platform Qt Framework. To compile the GUI, Qt 5 is required.
