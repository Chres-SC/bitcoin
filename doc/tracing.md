...
Multiple tools can list the available tracepoints in a `revoltd` binary with
USDT support.
...
stap net        inbound_message  0x000000000014419e /src/revoltd
stap net        outbound_message 0x0000000000107c05 /src/revoltd
stap validation block_connected  0x00000000002fb10c /src/revoltd
…
```
...
```
$ readelf -n ./src/revoltd | grep NT_STAPSDT -A 4 -B 2
