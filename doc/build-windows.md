...
Below are some notes on how to build Revolt core for Windows.

The options known to work for building Revolt core on Windows are:
...
Note that for WSL the Revolt core source path MUST be somewhere in the default mount file system, for
...
way. This will install to `c:\workspace\revolt`, for example:
