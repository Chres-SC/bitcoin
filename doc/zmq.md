...
The Revolt Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Revolt Core requires the ZeroMQ API >= 4.0.0
...
during the *configure* step of building revoltd:
...
For instance:
    ...
    $ revoltd -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubhashtx=tcp://192.168.1.2:28332 \
               -zmqpubhashblock="tcp://[::1]:28333" \
               -zmqpubrawtx=ipc:///tmp/revoltd.tx.raw \
...
From the perspective of revoltd, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into revoltd directly. Furthermore, no information is
...
using. Revoltd appends an up-counting sequence number to each
