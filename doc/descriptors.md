# Support for Output Descriptors in Revolt Core

Since Revolt Core v0.17, there is support for Output Descriptors. This is a
...
transactions related to the multisig. Lastly, it is not recommended to use anything other than a Revolt Core descriptor wallet to serve as your
...
existing Revolt Core wallets, a convenience function `combo` is
...
All RPCs in Revolt Core will include the checksum in their output. Only
