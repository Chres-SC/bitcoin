...
#ifndef REVOLT_POLICY_FEERATE_H
#define REVOLT_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "RVT"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    RVT_KVB,      //!< Use RVT/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::RVT_KVB) const;

    SERIALIZE_METHODS(CFeeRate, obj) { READWRITE(obj.nSatoshisPerK); }
};

#endif // REVOLT_POLICY_FEERATE_H
