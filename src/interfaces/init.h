...
#ifndef REVOLT_INTERFACES_INIT_H
#define REVOLT_INTERFACES_INIT_H
...
//! (bitcoin-gui, bitcoin-node, revolt-wallet, revoltd, bitcoin-qt) and each
...
#endif // REVOLT_INTERFACES_INIT_H
