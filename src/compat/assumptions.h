...
#ifndef REVOLT_COMPAT_ASSUMPTIONS_H
#define REVOLT_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Revolt cannot be compiled without assertions."
#endif
...
#endif // REVOLT_COMPAT_ASSUMPTIONS_H
