...
#ifndef REVOLT_QT_RECEIVECOINSDIALOG_H
#define REVOLT_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of revolts */
...
#endif // REVOLT_QT_RECEIVECOINSDIALOG_H
