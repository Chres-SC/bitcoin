...
#ifndef REVOLT_WALLET_SCRIPTPUBKEYMAN_H
#define REVOLT_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Revolt Core wallet was originally a collection of unrelated private
...
#endif // REVOLT_WALLET_SCRIPTPUBKEYMAN_H
