...
$(package)_config_opts_arm_linux += -platform linux-g++ -xplatform revolt-linux-g++
...
$(package)_config_opts_powerpc64_linux = -platform linux-g++ -xplatform revolt-linux-g++
$(package)_config_opts_powerpc64le_linux = -platform linux-g++ -xplatform revolt-linux-g++
$(package)_config_opts_riscv64_linux = -platform linux-g++ -xplatform revolt-linux-g++
$(package)_config_opts_s390x_linux = -platform linux-g++ -xplatform revolt-linux-g++
...
# revolt-linux-g++, replace instances of linux-arm-gnueabi with $(host). This
...
define $(package)_preprocess_cmds
  ...
  cp -r qtbase/mkspecs/linux-arm-gnueabi-g++ qtbase/mkspecs/revolt-linux-g++ && \
  sed -i.old "s/arm-linux-gnueabi-/$(host)-/g" qtbase/mkspecs/revolt-linux-g++/qmake.conf && \
